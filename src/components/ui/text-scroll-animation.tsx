...
const CharacterV2 = ({
  ...
  return (
    <motion.img
      src={char}
      alt=""
      className="h-16 w-16 shrink-0 object-contain will-change-transform filter brightness-0 invert"
...
const Skiper31 = () => {
  ...
  const macIcon = [
    ...
    "https://cdn.jsdelivr.net/npm/simple-icons@v13/icons/nodejs.svg",
  ...
  return (
    <ReactLenis root>
      <main className="w-full bg-transparent text-white">
        ...
        <div
          ref={targetRef2}
          className="relative -mt-[100vh] box-border flex h-[210vh] flex-col items-center justify-center gap-[2vw] overflow-hidden bg-transparent p-[2vw]"
        >
          <p className="font-geist flex items-center justify-center gap-3 text-2xl font-medium tracking-tight text-white">
            ...
            <span className="font-geist font-medium">Powering Innovation at Alpha Team</span>
        ...
        {/* Block 3 — icons (variant with rotation) */}
        <div
          ref={targetRef3}
